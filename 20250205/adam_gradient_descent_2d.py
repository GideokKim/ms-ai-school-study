...
# Adam 최적화 수행
optimizer = Adam(lr=0.4, beta1=0.9, beta2=0.999)
...
ax1.set_title('3D Surface with Adam Path', pad=20)
...
ax2.set_xlabel('x')
ax2.set_ylabel('y')
ax2.set_title('Contour Plot with Adam Path')
...
# GIF로 저장
anim.save('adam_gradient_descent.gif', writer='pillow', fps=10)
...
# GIF로 저장
anim.save('adam_gradient_descent2.gif', writer='pillow', fps=10)