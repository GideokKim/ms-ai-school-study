...
# RMSprop 최적화 수행
optimizer = RMSprop(lr=0.1, decay_rate=0.99)  # RMSprop는 작은 학습률과 decay_rate 사용
...
ax1.set_title('3D Surface with RMSprop Path', pad=20)
...
ax2.set_xlabel('x')
ax2.set_ylabel('y')
ax2.set_title('Contour Plot with RMSprop Path')
...
# GIF로 저장
anim.save('rmsprop_gradient_descent.gif', writer='pillow', fps=10)
