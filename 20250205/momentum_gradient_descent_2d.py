...
# Momentum 최적화 수행
optimizer = Momentum(lr=0.04, momentum=0.9)
...
ax1.set_title('3D Surface with Momentum Path', pad=20)
...
ax2.set_xlabel('x')
ax2.set_ylabel('y')
ax2.set_title('Contour Plot with Momentum Path')
...
# GIF로 저장
anim.save('momentum_gradient_descent.gif', writer='pillow', fps=10)